        ...
        <div className="flex flex-col justify-center text-left py-12 lg:py-0">
            ...
            >
                <h1 className="max-w-3xl mb-6 text-5xl font-extrabold tracking-tight leading-tight text-gray-900 dark:text-white md:text-6xl">
                    <span className="text-saas-blue dark:text-blue-400">JobSathi:</span><br />
                    The Professional<br />
                    Voice-Powered Resume<br />
                    Builder.
                </h1>

                <p className="max-w-2xl mb-8 text-lg font-normal text-gray-600 dark:text-gray-300 leading-relaxed">
                    JobSathi: The Professional Voice-Powered Resume Builder, provides boosting your citovators and language.
                </p>
                ...
                <div className="mb-16">
                    ...
                    >
                        <span className="mr-2">Start Building Your Resume</span>
                ...
                <div className="flex flex-wrap gap-12 md:gap-16 pt-8 border-t border-gray-100 dark:border-gray-800">
                    <FeatureItem icon={BrainCircuit} label="AI-Powered" subLabel="Precision" />
                    <FeatureItem icon={CheckCircle} label="ATS-Optimized" subLabel="" />
                    <FeatureItem icon={Download} label="Instant" subLabel="Download" />
                </div>
            </motion.div>
        </div>
    );
